...
const AdminSidebar = ({ onLogout }) => {
  ...
  const menuItems = [
    ...
    {
      id: 'ai',
      label: 'AI Recommendation Insights',
      icon: (
        <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    <div className="w-64 bg-gray-50 border-r border-gray-200 min-h-screen flex flex-col">
      ...
      <div className="p-6 border-b border-gray-200">
        <div className="flex items-center space-x-3">
          ...
          <div>
            <h1 className="text-lg font-bold text-gray-900">SIDDHI</h1>
      ...
      <div className="p-4 border-t border-gray-200">
        <button
          onClick={onLogout}
          className="w-full flex items-center justify-center space-x-2 px-4 py-2 bg-red-600 text-white rounded-full text-sm font-medium hover:bg-red-700 transition-colors"
        >

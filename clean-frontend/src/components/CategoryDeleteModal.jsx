...
const CategoryDeleteModal = ({ isOpen, onClose, onConfirm, categoryName, itemCount, isLoading }) => {
                ...
                <div className="flex">
                  ...
                  <div className="ml-3">
                    ...
                    <div className="mt-2 text-sm text-yellow-700">
                      <p>
                        The category <strong>"{categoryName}"</strong> contains <strong>{itemCount} menu items</strong>. 
                        Please move or delete all items in this category before deleting the category.
                      </p>
                    </div>
                  </div>
                </div>

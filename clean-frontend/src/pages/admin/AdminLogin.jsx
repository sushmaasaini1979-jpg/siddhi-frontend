...
const AdminLogin = () => {
  ...
  const { setAdminAuth, isAdminAuthenticated } = useStore()
  ...
  const loginMutation = useMutation(
    (credentials) => api.login(credentials.email, credentials.password),
    {
      onSuccess: (data) => {
        ...
        <div className="bg-white rounded-lg shadow-sm p-6">
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <button
              ...
              className="w-full bg-gray-800 text-white py-3 rounded-lg font-medium hover:bg-gray-700 transition-colors disabled:opacity-50"
            >
